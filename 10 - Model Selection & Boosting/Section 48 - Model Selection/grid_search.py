...
"""
VALUTA LE PERFORMANCE DEL MODELLO con CROSS VALIDATION
"""
...
"""
MIGLIORA LE PERFORMANCE DEL MODELLO con GRID SEARCH

con greed search riusciamo a capire quali sono i parametri più influenti per il modello da modificare

il modello è SVC, quindi dobbiamo vedere cosa ottimizzare di SVC guardando la libreria
"""
...
parameters = [
        {
                # prova linear con vari C
                'C': [1, 10, 100, 1000],
                'kernel': ['linear']
        },
        {
                # prova rbf con vari C e varie gamma
                'C': [1, 10, 100, 1000],
                'kernel': ['rbf'],
